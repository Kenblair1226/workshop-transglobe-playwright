...
Playwright 與 App Modernization 是兩個獨立 Track，不共用案例或驗證流程。

| 時間 | Session | 形式 | 主要成果 |
|---|---|---|---|
| 13:30–13:35 | 開場 | Briefing | 了解目標、流程與環境 |
...
| 16:10–16:45 | Java App Modernization Demo | Checkpoint Demo | 分析、規劃、修改、測試與人工 Gate |
| 16:45–17:00 | 總結與 Q&A | Discussion | 選出後續 PoC candidate |

## 時間控制

- 15:35 為 Playwright hard stop。
- Lab 落後時省略 Bonus，不壓縮最後 Q&A。
- App Modernization live Apply 最多 12 分鐘；超時立即切換 modernized checkpoint。
